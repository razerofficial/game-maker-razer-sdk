...
if (RazerSDK_IsConnected(varPlayer))
{
...
if (RazerSDK_GetButton(varPlayer, BUTTON_U))
{
    draw_sprite(2, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_Y))
{
    draw_sprite(3, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_A))
{
    draw_sprite(4, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_DPAD_DOWN))
{   
    draw_sprite(6, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_DPAD_LEFT))
{
    draw_sprite(7, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_DPAD_RIGHT))
{
    draw_sprite(8, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_DPAD_UP))
{
    draw_sprite(9, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_L1))
{
    draw_sprite(11, -1, x, y);
}

if (RazerSDK_GetAxis(varPlayer, AXIS_L2) > deadzone)
{
    draw_sprite(12, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_O))
{
    draw_sprite(13, -1, x, y);
}

if (RazerSDK_GetButton(varPlayer, BUTTON_R1))
{
    draw_sprite(15, -1, x, y);
}

if (RazerSDK_GetAxis(varPlayer, AXIS_R2) > deadzone)
{
    draw_sprite(16, -1, x, y);
}

if (RazerSDK_GetButtonUp(varPlayer, BUTTON_MENU))
{
...
varX = RazerSDK_GetAxis(varPlayer, AXIS_LS_X);
if (varX == undefined)
{
    varX = 0;
}

varY = RazerSDK_GetAxis(varPlayer, AXIS_LS_Y);
if (varY == undefined)
{
    varY = 0;
}

if (RazerSDK_GetButton(varPlayer, BUTTON_L3))
{
...
varX = RazerSDK_GetAxis(varPlayer, AXIS_RS_X);
if (varX == undefined)
{
    varX = 0;
}

varY = RazerSDK_GetAxis(varPlayer, AXIS_RS_Y);
if (varY == undefined)
{
    varY = 0;
}
    
if (RazerSDK_GetButton(varPlayer, BUTTON_R3))
{
